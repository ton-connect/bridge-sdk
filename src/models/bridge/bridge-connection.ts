...
import { WalletConnectionSourceHTTP } from '../wallet/wallet-connection-source';
import { Optional } from '../../utils/types';

export const CONNECTION_HTTP_EXPIRATION_TIME = 5 * 60 * 1000;

export type BridgeConnection = BridgeConnectionHttp | BridgePendingConnectionHttp | BridgeConnectionInjected;
...
export function isExpiredPendingConnectionHttpRaw(connection: BridgePendingConnectionHttpRaw): boolean {
...
export type BridgeConnectionRaw = BridgeConnectionHttpRaw | BridgePendingConnectionHttpRaw | BridgeConnectionInjected;
